      ...
      <div className="h-full w-full flex flex-col p-4 md:p-8 space-y-6 max-w-7xl mx-auto">
        ...
        <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 min-h-[500px]">
            ...
            <div className="glass-strong rounded-3xl p-6 flex flex-col gap-4 border border-white/10 relative group focus-within:border-aurora-indigo/50 transition-colors">
                ...
                <div className="flex items-center justify-between border-b border-white/5 pb-4">
                    <div className="relative group/dropdown">
                        ...
                        >
                            <option value="auto" className="bg-slate-900">Detect Language</option>
                            {LANGUAGES.map(l => (
                                <option key={l.code} value={l.code} className="bg-slate-900">{l.label}</option>
                            ))}
                        </select>
                        <Languages size={16} className="absolute right-3 top-1/2 -translate-y-1/2 text-white/40 pointer-events-none" />
                    </div>
            ...
            <div className="glass rounded-3xl p-6 flex flex-col gap-4 border border-white/5 relative overflow-hidden bg-white/[0.02]">
                ...
                {isLoading && (
                    <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/5 to-transparent animate-shimmer z-0 pointer-events-none" 
                ...
                <div className="flex items-center justify-between border-b border-white/5 pb-4 relative z-10">
                    <div className="relative">
                        ...
                        <Languages size={16} className="absolute right-3 top-1/2 -translate-y-1/2 text-aurora-indigo/60 pointer-events-none" />
                    </div>
                </div>
                ...
                <div className="flex-1 relative z-10">
                    {isLoading ? (
                        ...
                        <div className={`text-lg md:text-xl leading-relaxed transition-colors duration-300 ${outputText ? 'text-white' : 'text-white/10'}`}>
