      ...
      >
            ...
            return (
              ...
              >
                <item.icon 
                  ...
                  className={`${
                      isActive 
                        ? theme === 'midnight' ? 'text-white' : 'text-aurora-indigo' 
        ...
        <div className="px-4 pb-2 space-y-2">
          ...
          >
            ...
            <div className={`w-8 h-4 rounded-full relative transition-colors ${theme === 'midnight' ? 'bg-white/20' : 'bg-aurora-indigo/30'}`}>
                <div className={`absolute top-0.5 w-3 h-3 rounded-full bg-white transition-transform ${theme === 'midnight' ? 'left-4.5 translate-x-4' : 'left-0.5'}`} />
            </div>
          </button>
        </div>
