    ...
    return (
        <div className="relative group w-full max-w-md hidden sm:block" ref={searchRef}>
            ...
            <div className="relative z-50">
                <Search className={`absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 transition-colors ${isOpen ? 'text-aurora-indigo' : 'text-white/30 group-focus-within:text-aurora-indigo'}`} />
                <input 
                    type="text" 
                    value={query}
