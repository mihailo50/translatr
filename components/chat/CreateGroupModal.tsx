...
import { X, Users, Upload, ArrowRight, ArrowLeft, CheckCircle2 } from "lucide-react";
...
export default function CreateGroupModal({ isOpen, onClose, friends }: CreateGroupModalProps) {
  ...
  const [_groupAvatar, setGroupAvatar] = useState<File | null>(null); // Reserved for future use
            ...
            <div className="space-y-4 animate-in fade-in slide-in-from-right-4 duration-300">
                    ...
                    >
                      ...
                      <div className="shrink-0">
                        {isSelected ? (
                          <CheckCircle2
                            size={20}
                            className="text-indigo-400 drop-shadow-[0_0_8px_rgba(99,102,241,0.6)]"
                          />
                        ) : (
              ...
              <div className="sticky bottom-0 pt-4 border-t border-white/10 bg-[#050510]/95 backdrop-blur-xl">
                <div className="flex items-center justify-between">
                  <p className="text-sm text-white/50">{selectedMembers.size}/10 Selected</p>
                  <button
                    onClick={handleNext}
            ...
            <div className="space-y-6 animate-in fade-in slide-in-from-left-4 duration-300">
              ...
              <div className="flex flex-col items-center">
                ...
                <p className="text-xs text-white/40 mt-2">
                  Click to upload group avatar (optional)
                </p>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  autoFocus
                />
                <p className="text-xs text-white/40 mt-1.5">{groupName.length}/100 characters</p>
              </div>
